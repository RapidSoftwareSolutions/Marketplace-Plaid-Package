<?php
$app->post('/api/Plaid/updateAccessTokenVersion', function ($request, $response) {

    $requestUrl = '/item/access_token/update_version';
    $option = array(
        "clientId" => "client_id",
        "secret" => "secret",
        "accessTokenOld" => "access_token_v1"
    );
    ...
    $validateRes = $checkRequest->validate($request, ["clientId","secret","accessTokenOld"]);
