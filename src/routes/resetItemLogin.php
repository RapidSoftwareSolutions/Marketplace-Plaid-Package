...
$app->post('/api/Plaid/resetItemLogin', function ($request, $response) {

    $settings = $this->settings;
    //remove sandbox in prodaction version
    if($settings['baseUrl'] == 'https://sandbox.plaid.com')
      {
          $requestUrl = '/sandbox/item/reset_login';
      } else {
          $requestUrl = '/item/reset_login';
      }
    $option = array(
        "clientId" => "client_id",
        "secret" => "secret",
