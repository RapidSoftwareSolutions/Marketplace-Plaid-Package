...
$app->post('/api/Plaid/searchInstitution', function ($request, $response) {

    $requestUrl = '/institutions/search';
    $option = array(
        "querySearch" => "query",
    ...
    $validateRes = $checkRequest->validate($request, ["querySearch","productsType","publicKey"]);
