...
$app->post('/api/Plaid/getCategories', function ($request, $response) {

    $requestUrl = '/categories/get';
    $option = array();
    ...
    try {
        ...
        $resp =  $client->request('POST', $url ,['body' => '{}', 'headers' => ['Content-Type' => 'application/json'] ] );
