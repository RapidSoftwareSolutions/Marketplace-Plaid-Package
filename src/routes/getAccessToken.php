...
$app->post('/api/Plaid/getAccessToken', function ($request, $response) {

    $requestUrl = '/item/public_token/exchange';
    $option = array(
        "clientId" => "client_id",
        "secret" => "secret",
    ...
    $validateRes = $checkRequest->validate($request, ["clientId","secret","publicToken"]);
